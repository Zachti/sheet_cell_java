...
public final class TypedContextStore<T> { // every store is a singleton
    ...
    private static final TypedContextStore<Boolean> IS_OBSERVER_UPDATE = new TypedContextStore<>();
    ...
    public static TypedContextStore<Boolean> getIsObserverUpdateStore() { return IS_OBSERVER_UPDATE; }
}
